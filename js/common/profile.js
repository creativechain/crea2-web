...
(function () {
    ...
    function setUpRewards(rewardView, session, state) {
        ...
        state.user.transfer_history.sort(function (r1, r2) {
            var d1 = dateFromUTCString(r1[1].timestamp);
            var d2 = dateFromUTCString(r2[1].timestamp);
    ...
    function sendAccountUpdate(event, keys, callback) {
        var lastUpdate = dateFromUTCString(profileContainer.state.user.last_account_update);
        var now = new Date();
                ...
                if (!catchError(err)) {
                    ...
                    getProfileDiscussions(function (err, discussions) {
                        ...
                        discussions.sort(function (k1, k2) {
                            var d1 = dateFromUTCString(k1.created);
                            var d2 = dateFromUTCString(k2.created);
                            return d2.getTime() - d1.getTime();
                        });
