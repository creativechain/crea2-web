...
$jscomp.polyfill("Number.MAX_SAFE_INTEGER",function(){return 9007199254740991},"es6","es3");var IpfsFile=function(a,c,b,d){this.hash=a;this.name=c;this.type=b;this.size=d;this.url="https://ipfs3.creary.net/ipfs/"+a},creaEvents=new EventEmitter;moment.locale($("html").attr("lang"));
