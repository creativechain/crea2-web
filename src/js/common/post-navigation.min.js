...
this.$forceUpdate()},getFeaturedImage:function(a){return(a=a.metadata.featuredImage)&&a.hash?{url:"https://ipfs.creary.net/ipfs/"+a.hash}:a&&a.url?a:{}},getLinkedTags:function(a){var b=[];this.state.post.metadata.tags.forEach(function(a){b.push('<a href="/popular/'+encodeURIComponent(a)+'">'+a+"</a>")});return a?b.join(", "):b},isSameUser:function(){return this.session?this.state.post.author===this.session.account.username:!1},isCommentResponse:function(a,c){return a.parent_author===c.author&&a.parent_permlink===
c.permlink},editPost:function(){goTo("/publish?edit="+encodeURIComponent(this.state.post.author+"/"+this.state.post.permlink))},addComment:function(a,c,e){var b=this;makeComment(c?this.response_comment:this.comment,e,a,function(a,e){globalLoading.show=!1;catchError(a)||(c?b.cleanMakeResponse():b.cleanMakeComment(),p(b.state.post,b.state,b.state.discuss,b.state.category,null,!0))})},linkfy:function(a){return makeMentions(a,this.state)},mustShowCommentField:function(a){return null!=this.active_response&&
this.active_response.link===a.link||null!=this.active_response_edit&&this.active_response_edit.parent_author===a.author&&this.active_response_edit.parent_permlink===a.permlink},setActiveComment:function(a){this.active_comment=a;q&&(q.active_comment=a,q.$forceUpdate());this.$forceUpdate()},setActiveCommentEdit:function(a){this.active_comment_edit=a;this.comment=a.body;this.$forceUpdate()},cleanMakeComment:function(){this.active_comment_edit=this.active_comment=null;this.comment="";this.$forceUpdate()},
cleanMakeResponse:function(){this.active_response_edit=this.active_response=null;this.response_comment="";this.$forceUpdate()},makeDownload:makeDownload,removeComment:function(a){var b=this;deleteComment(a,this.session,function(a,c){catchError(a)||(globalLoading.show=!1,p(b.state.post,b.state,b.state.discuss,b.state.category,null,!0))})},editComment:function(a){this.response_comment=a.body;this.active_response_edit=a},ignoreUser:function(a){function b(){return a.apply(this,arguments)}b.toString=function(){return a.toString()};
return b}(function(){ignoreUser(this.state.post.author,!0,function(a,c){d()})}),vote:function(a,c){console.log("Vote",a,c);c=c||this.state.post;if(this.session){var b=this,e=this.session.account.username;requireRoleKey(e,"posting",function(d){globalLoading.show=!0;crea.broadcast.vote(d,e,c.author,c.permlink,a,function(a,c){globalLoading.show=!1;catchError(a)||(p(b.state.post,b.state,b.state.discuss,b.state.category,null,!0),showModal("#modal-post"))})})}},onVote:function(a){catchError(a)||p(this.state.post,
this.state,this.state.discuss,this.state.category,null,!0)},onFollow:function(a,c){console.log("on follow-nav",a,c);catchError(a)||updateUserSession()}}});k.$forceUpdate();if(h){t?(t.session=h,t.user=f?f.user:null,t.state=a):t=new Vue({el:"#modal-promote",data:{lang:lang,session:h,user:f?f.user:null,state:a,amount:0},mounted:function(){},methods:{hideModalPromote:function(a){cancelEventPropagation(a);hideModal("#modal-promote");showModal("#modal-post")},makePromotion:function(a){cancelEventPropagation(a);
var b=this.session.account.username,c="@"+this.state.post.author+"/"+this.state.post.permlink,e=parseFloat(this.amount)+1E-4;console.log(e);e=Asset.parse({amount:e,nai:apiOptions.nai.CBD}).toFriendlyString(null,!1);console.log(e);var d=this;requireRoleKey(b,"active",function(a){globalLoading.show=!0;crea.broadcast.transfer(a,b,"null",e,c,function(a,b){globalLoading.show=!1;catchError(a)||(d.hideModalPromote(),updateUserSession())})})}}});if(a.post.download.resource)if(u)u.session=h,u.user=f?f.user:
null,u.state=a;else{var c=Asset.parse(a.post.download.price),e=c.asset.symbol===apiOptions.symbol.CREA?Asset.parseString("0.000 CREA"):Asset.parseString("0.000 CBD"),g=!1;h&&(e=c.asset.symbol===apiOptions.symbol.CREA?Asset.parseString(f.user.balance):Asset.parseString(f.user.cbd_balance),g=a.post.download.downloaders.includes(f.user.name));u=new Vue({el:"#modal-download",data:{lang:lang,session:h,user:f?f.user:!1,state:a,modal:{amount:c.toPlainString(null,!1),symbol:c.asset.symbol.toUpperCase(),balance:e.toFriendlyString(null,
!1),alreadyPayed:g,confirmed:!1}},mounted:function(){},methods:{cancelPay:function(){this.modal.confirmed=!1},confirmDownload:function(){console.log("Donwload content",this.modal.alreadyPayed,this.modal.confirmed);this.modal.alreadyPayed||this.modal.confirmed?makeDownload(null,h,this.user,this.state.post,function(){console.log("On download success");showModal("#modal-post")}):this.modal.confirmed=!0}}})}v?(v.session=h,v.user=f?f.user:null,v.state=a):v=new Vue({el:"#modal-report",data:{lang:lang,session:h,
user:f?f.user:null,state:a},methods:{vote:function(a,c){console.log("Vote",a,c);c=c||this.state.post;if(this.session){var b=this,e=this.session.account.username;requireRoleKey(e,"posting",function(d){globalLoading.show=!0;crea.broadcast.vote(d,e,c.author,c.permlink,a,function(a,c){globalLoading.show=!1;catchError(a);p(b.state.post,b.state,b.state.discuss,b.state.category,null,!0);showModal("#modal-post")})})}}}});q?(q.session=h,q.user=f?f.user:null,q.state=a):q=new Vue({el:"#modal-report-comment",
...
c=b.discuss||"";b.discussion_idx[c]||(b.discussion_idx[c]={});b.discussion_idx[c].more_projects=e;p(a,k.state,c,"more_projects",e.indexOf(a.link))},getFeaturedImage:function(a){return(a=a.metadata.featuredImage)&&a.hash?{url:"https://ipfs.creary.net/ipfs/"+a.hash}:a&&a.url?a:{}}}});w.$forceUpdate()},b=(new Date).toISOString().replace("Z","");crea.api.getDiscussionsByAuthorBeforeDateWith({start_permlink:"",limit:100,before_date:b,author:a},function(a,b){if(!catchError(a)){var d=[];console.log("Other projects",
