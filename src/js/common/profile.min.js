...
encodeURIComponent(a)+'">'+a+"</a>")}),b)?k.join(", "):k},hasPaid:function(a){var b=moment();a=toLocaleDate(a.cashout_time);return b.isAfter(a)},getPayoutPostDate:function(a){var b=toLocaleDate(a.cashout_time);this.hasPaid(a)&&(b=toLocaleDate(a.last_payout));return b.fromNow()},hasPromotion:function(a){return 0<Asset.parseString(a.promoted).amount},getPromotion:function(a){return"$ "+Asset.parseString(a.promoted).toPlainString()},parseJSON:function(a){if(a&&0<a.length)try{return JSON.parse(a)}catch(I){catchError(I)}return{}},
