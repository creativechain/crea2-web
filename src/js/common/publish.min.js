...
switch(u.user.metadata.post_rewards){case "0":e.push(crea.broadcast.commentOptionsBuilder(b,n,"0.000 CBD",1E4,!0,!0,[]));break;case "100":e.push(crea.broadcast.commentOptionsBuilder(b,n,"1000000.000 CBD",0,!0,!0,[]))}var f=[a];(d=crea.broadcast).sendOperations.apply(d,[f].concat(e,[function(a,b){catchError(a)?globalLoading.show=!1:(console.log(b),a={url:"/"+toPermalink(h.tags[0])+"/@"+p.account.username+"/"+n},showPost(a))}]))};r?v():crea.api.getDiscussion(b,n,function(a,b){console.log(a,b);a||(0!==
