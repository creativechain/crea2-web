...
catchError(a)||(d.featuredImage=b,h[b.hash]=c,d.error=null)})})}},toggleEditor:function(a){cancelEventPropagation(a);this.editor.show||(this.editor.show=!this.editor.show)},editorInput:function(a){this.editor.editing=0<a.length},updateText:e,removeTitleEmojis:f,removeDescriptionEmojis:b,editText:g,removeElement:m,makePublication:x,humanFileSize:humanFileSize,stringFormat:String.format}})}function f(a){c.title=removeEmojis(a.target.value)}function b(a){c.description=removeEmojis(a.target.value)}function e(){var a=
0<arguments.length&&void 0!==arguments[0]?arguments[0]:-1,b=CKEDITOR.instances.editor,e=b.getData();e.isEmpty()||(-1<a?c.bodyElements[a].value=e:c.bodyElements.push({value:e,type:"text/html"}),c.updatingIndex=-1,b.setData(""),c.editor.editing=!1,c.editor.show=!1)}function g(a){console.log("Editing text",a);-1<a&&(c.editor.show=!0,setTimeout(function(){CKEDITOR.instances.editor.setData(c.bodyElements[a].value);c.updatingIndex=a;c.editor.editing=!0},500))}function m(a){if(-1<a&&a<=c.bodyElements.length-
1){var b=c.bodyElements[a];c.bodyElements.splice(a,1);b.type.includes("image/")&&(a=h[b.hash],a.resized.name===c.featuredImage.name&&a.resized.size===c.featuredImage.size&&(c.featuredImage={},delete h[b.hash]));if(!c.featuredImage.hash)for(a=0;a<c.bodyElements.length;a++)if(b=c.bodyElements[a],b.type.includes("image/")){a=CONSTANTS.FILE_MAX_SIZE.POST_PREVIEW.IMAGE;var d=h[b.hash];console.log("Selected new featured image",d.resized.name,b.hash);uploadToIpfs(d.resized,a,function(a,b){a?console.error(a,
d.resized):(console.log("Preview uploaded",b),c.featuredImage=b,console.log("Featured image loaded!"))});break}c.$forceUpdate()}}function x(a){cancelEventPropagation(a);var b=p.account.username;requireRoleKey(b,"posting",function(a){var d;globalLoading.show=!0;for(var e=c.tags,f=[],g=0;g<e.length;g++){var k=normalizeTag(e[g]);f.includes(k)||f.push(k)}var h={description:c.description,tags:f,adult:c.adult,featuredImage:c.featuredImage,license:c.getLicense().getFlag()},l=c.downloadFile;l.price||(l.price=
0);l.price=Asset.parseString(l.price+" "+l.currency).toFriendlyString(null,!1);l.resource||(l="");var m=jsonstring(c.bodyElements),t=c.title,r=!!c.editablePost,n=r?c.editablePost.permlink:toPermalink(t),v=function(){if(r&&c.editablePost.metadata.tags){var e=c.editablePost.metadata.tags[0];e&&!h.tags.includes(e)&&h.tags.unshift(e)}e=[];e.push(crea.broadcast.commentBuilder("",toPermalink(h.tags[0]),b,n,t,m,jsonstring(l),jsonstring(h)));switch(u.user.metadata.post_rewards){case "0":e.push(crea.broadcast.commentOptionsBuilder(b,
n,"0.000 CBD",1E4,!0,!0,[]));break;case "100":e.push(crea.broadcast.commentOptionsBuilder(b,n,"1000000.000 CBD",0,!0,!0,[]))}var f=[a];(d=crea.broadcast).sendOperations.apply(d,[f].concat(e,[function(a,b){catchError(a)?globalLoading.show=!1:(console.log(b),a={url:"/"+toPermalink(h.tags[0])+"/@"+p.account.username+"/"+n},showPost(a))}]))};r?v():crea.api.getDiscussion(b,n,function(a,b){console.log(a,b);a||(0!==b.id?(catchError(lang.ERROR.PERMLINK_ALREADY_EXISTS),globalLoading.show=!1):v())})})}var p,
u,c,h={};creaEvents.on("crea.content.loaded",function(){var b=getParameterByName("edit");if(b){var c=b.split("/")[0];b=b.split("/")[1];var e=Session.getAlive();e&&e.account.username===c&&crea.api.getDiscussion(c,b,function(b,c){catchError(b)||(c=parsePost(c),b=Asset.parse(c.download.price),c.download.price=parseFloat(b.toPlainString()),c.download.currency=b.asset.symbol,c.downloadUploaded=!1,a(c))})}else a()});creaEvents.on("crea.session.login",function(a,b){p=a;c&&(c.session=a,c.$forceUpdate());
