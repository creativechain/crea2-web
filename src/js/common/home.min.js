...
this.category);showModal("#modal-post")},parseAsset:function(a){return Asset.parse(a).toFriendlyString()},getBuzzClass:function(a){var b={};b[a.buzz.level_name]=!0;return b},getFeaturedImage:function(a){return(a=!this.account||this.account&&"warn"===this.account.user.metadata.adult_content&&a.adult_content?{url:R.IMG.POST.NSFW}:a.metadata.featuredImage)&&a.hash?{url:apiOptions.ipfs+a.hash}:a&&a.url?a:{}},getTags:function(a){a=a.metadata.tags;var b=[];a=a.slice(0,7);a.forEach(function(a){b.push('<a href="/search?page=1&query='+
