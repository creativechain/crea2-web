(function(){function z(){d?(d.session=g,d.account=r,d.$forceUpdate()):d=new Vue({el:"#market-container",data:{lang:lang,session:g,account:r,recentTrades:[],ticker:{penultimate:null,latest:"0.000000",lowest_ask:"0.000000",highest_bid:"0.000000",percent_change:"0.000000",crea_volume:"0.000 CREA",cbd_volume:"0.000 CREA"},buyForm:{price:"0.000",amount:"0.000",total:"0.000"},sellForm:{price:"0.000",amount:"0.000",total:"0.000"}},methods:{parseAsset:Asset.parse,dateFromNow:function(b){return moment(toLocaleDate(b)).fromNow()},
...
params:[100]},function(b,a){if(!catchError(b)){var c=[],e=[];b=mixToArray(n.rows().data());var d=mixToArray(l.rows().data()),k=function(a){return{price:a.order_price,crea:a.crea,cbd:a.cbd,total_cbd:a.total_cbd}},f=0,g=0;a.bids.forEach(function(a,b){a.order_price=Asset.parse({amount:a.real_price,nai:"cbd",exponent:6}).toPlainString();a.crea=Asset.parse({amount:a.crea,nai:"crea"}).toPlainString();a.cbd=Asset.parse({amount:a.cbd,nai:"cbd"}).toPlainString();f+=parseFloat(a.cbd);a.total_cbd=Asset.parse({amount:f,
nai:"cbd"}).toPlainString();c.push(k(a))});c.sort(function(a,b){return b.price-a.price});isEqual(b,c)||(n.clear(),v.clear(),n.rows.add(c).draw(),v.rows.add(c).draw());a.asks.forEach(function(a,b){a.order_price=Asset.parse({amount:a.real_price,nai:"cbd",exponent:6}).toPlainString();a.crea=Asset.parse({amount:a.crea,nai:"crea"}).toPlainString();a.cbd=Asset.parse({amount:a.cbd,nai:"cbd"}).toPlainString();g+=parseFloat(a.cbd);a.total_cbd=Asset.parse({amount:g,nai:"cbd"}).toPlainString();e.push(k(a))});
e.sort(function(a,b){return b.price-a.price});isEqual(d,e)||(l.clear(),p.clear(),l.rows.add(e).draw(),p.rows.add(e).draw(),a=$(l.table().node()).parent(),a.scrollTop(a.get(0).scrollHeight),a=$(p.table().node()).parent(),a.scrollTop(a.get(0).scrollHeight))}})}function E(b,a){b&&$("[buy-last-price]").html(b);a&&$("[sell-last-price]").html(a)}function F(){h.send({method:"market_history_api.get_recent_trades",params:{limit:100}},function(b,a){if(b)console.error("Error getting recent trades",b);else{var c=
[],e,d;a.trades.sort(function(a,b){return(new Date(b.date)).getTime()-(new Date(a.date)).getTime()});a.trades.forEach(function(a){a.date=moment(toLocaleDate(a.date)).fromNow();var b=Asset.parse(a.current_pays),f=Asset.parse(a.open_pays);a.current_pays=b.toPlainString();a.open_pays=f.toPlainString();a.cbd="CBD"===b.asset.symbol?a.current_pays:a.open_pays;a.crea="CBD"===b.asset.symbol?a.open_pays:a.current_pays;a.type="CBD"===b.asset.symbol?"buy":"sell";a.price=Asset.parse({amount:"CBD"===b.asset.symbol?
a.current_pays/a.open_pays:a.open_pays/a.current_pays,nai:"cbd",exponent:6}).toPlainString();c.push(a);"sell"!==a.type||e||(e=a.price);"buy"!==a.type||d||(d=a.price)});b=mixToArray(q.rows().data());isEqual(b,c)||(q.clear(),q.rows.add(c).draw());E(e,d)}})}function G(){var b=moment();b={method:"market_history_api.get_market_history",params:{bucket_seconds:86400,end:b.format("YYYY-MM-DD[T]H:mm:ss"),start:b.subtract(1,"months").format("YYYY-MM-DD[T]H:mm:ss")}};h.send(b,function(a,b){if(a)console.error("Fail getting chart data",
a);else{var c=[];b.buckets.forEach(function(a){a={date:moment(a.open).format("DD-MM-YYYY H:mm"),open:Asset.parse({amount:a.non_crea.open,nai:"cbd"}).toFloat(),high:Asset.parse({amount:a.non_crea.high,nai:"cbd"}).toFloat(),low:Asset.parse({amount:a.non_crea.low,nai:"cbd"}).toFloat(),close:Asset.parse({amount:a.non_crea.close,nai:"cbd"}).toFloat()};c.push(a)});isEqual(f?f.data:[],c)||H(c)}})}function I(b,a){var c=function(){C();t();D();F();G()};(a||void 0===a)&&c();b&&setInterval(function(){c()},b)}
function H(b){if(!f){am4core.useTheme(am4themes_animated);f=am4core.create("market-chart",am4charts.XYChart);f.paddingRight=20;f.dateFormatter.inputDateFormat="dd-MM-yyyy HH:mm";f.xAxes.push(new am4charts.DateAxis).renderer.grid.template.location=0;f.yAxes.push(new am4charts.ValueAxis).tooltip.disabled=!0;var a=f.series.push(new am4charts.CandlestickSeries);a.dataFields.dateX="date";a.dataFields.valueY="close";a.dataFields.openValueY="open";a.dataFields.lowValueY="low";a.dataFields.highValueY="high";
a.simplifiedProcessing=!0;a.tooltipText="Open: ${openValueY.value}\nLow: ${lowValueY.value}\nHigh: ${highValueY.value}\nClose: ${valueY.value}";a.riseFromOpenState.properties.fill=am4core.color("#25D77C");a.dropFromOpenState.properties.fill=am4core.color("#ff5766");a.riseFromOpenState.properties.stroke=am4core.color("#25D77C");a.dropFromOpenState.properties.stroke=am4core.color("#ff5766");f.cursor=new am4charts.XYCursor;a=f.series.push(new am4charts.LineSeries);a.dataFields.dateX="date";a.dataFields.valueY=
"close";a.defaultState.properties.visible=!1;a.hiddenInLegend=!0;a.fillOpacity=.5;a.strokeOpacity=.5;var c=new am4charts.XYChartScrollbar;c.series.push(a);f.scrollbarX=c}f.data=b}function J(){x||(x=!0,$.fn.dataTable.render.ellipsis=function(){return function(b,a,c){return"display"===a&&10<b.length?b.substr(0,10)+"\u2026":b}},n=$("#buy-orders").DataTable({bFilter:!1,bInfo:!1,aoColumnDefs:[{orderable:!1,aTargets:["_all"]}],order:[],scrollY:"250px",scrollCollapse:!0,paging:!1,columns:[{data:"price",
className:"color-buy",render:$.fn.dataTable.render.ellipsis()},{data:"crea",render:$.fn.dataTable.render.ellipsis()},{data:"cbd",render:$.fn.dataTable.render.ellipsis()}],fnCreatedRow:function(b,a,c){$(b).click(function(){m(a,"sell")})}}),v=$("#buy-orders-all").DataTable({bFilter:!1,bInfo:!1,lengthChange:!1,aoColumnDefs:[{orderable:!1,aTargets:["_all"]}],order:[],scrollY:"400px",scrollCollapse:!0,paging:!1,columns:[{data:"price",className:"color-buy",render:$.fn.dataTable.render.ellipsis()},{data:"crea",
render:$.fn.dataTable.render.ellipsis()},{data:"cbd",render:$.fn.dataTable.render.ellipsis()}],fnCreatedRow:function(b,a,c){$(b).click(function(){m(a,"sell")})}}),l=$("#sell-orders").DataTable({bFilter:!1,bInfo:!1,lengthChange:!1,aoColumnDefs:[{orderable:!1,aTargets:["_all"]}],order:[],scrollY:"250px",scrollCollapse:!0,paging:!1,columns:[{data:"price",className:"color-sell",render:$.fn.dataTable.render.ellipsis()},{data:"crea",render:$.fn.dataTable.render.ellipsis()},{data:"cbd",render:$.fn.dataTable.render.ellipsis()}],
fnCreatedRow:function(b,a,c){$(b).click(function(){m(a,"buy")})}}),p=$("#sell-all-orders").DataTable({bFilter:!1,bInfo:!1,lengthChange:!1,aoColumnDefs:[{orderable:!1,aTargets:["_all"]}],order:[],scrollY:"400px",scrollCollapse:!0,paging:!1,columns:[{data:"price",className:"color-sell",render:$.fn.dataTable.render.ellipsis()},{data:"crea",render:$.fn.dataTable.render.ellipsis()},{data:"cbd",render:$.fn.dataTable.render.ellipsis()}],fnCreatedRow:function(b,a,c){$(b).click(function(){m(a,"buy")})}}),
u=$("#user-orders").DataTable({bFilter:!1,bInfo:!1,lengthChange:!1,aoColumnDefs:[{orderable:!1,aTargets:["_all"]}],order:[],scrollY:"534px",scrollCollapse:!0,paging:!1,columns:[{data:"date"},{data:"expiration"},{data:"type",render:function(b,a,c,d){return"buy"===b.toLowerCase()?'<span class="color-buy">'+b.toUpperCase()+"</span>":'<span class="color-sell">'+b.toUpperCase()+"</span>"}},{data:"price"},{data:"crea"},{data:"cbd"},{data:"action",render:function(b,a,c,d){return'<div id="'+c.orderid+'" class="btn btn--sm"><span class="btn__text text__dark font-weight-bold"> '+
lang.BUTTON.CANCEL+"</span></a>"}}],fnCreatedRow:function(b,a,c){$("#"+a.orderid,b).click(function(){B(a.orderid)})}}),q=$("#market-history").DataTable({bFilter:!1,bInfo:!1,lengthChange:!1,aoColumnDefs:[{orderable:!1,aTargets:["_all"]}],order:[],scrollY:"200px",scrollCollapse:!0,paging:!1,columns:[{data:"date",render:$.fn.dataTable.render.ellipsis()},{data:"price",render:function(b,a,c,d){return"buy"===c.type.toLowerCase()?'<span class="color-buy">'+b+"</span>":'<span class="color-sell">'+b+"</span>"}},
{data:"crea",render:$.fn.dataTable.render.ellipsis()},{data:"cbd",render:$.fn.dataTable.render.ellipsis()}]}))}function y(b,a){g=b;r=a;z()}var d,x,n,v,l,p,u,q,f,g=null,r=null,h=new RpcWsClient("wss://nodes.creary.net");h.connect();h.on("ws.message",function(b,a){console.log("WS MSG",b,a)});creaEvents.on("crea.session.login",function(b,a){creaEvents.emit("crea.dom.ready");y(b,a);setTimeout(function(){console.log("session started");J();I(3E3)},500)});creaEvents.on("crea.session.update",function(b,a){y(b,
