<div class="modal-instance">
    <button class="modal-trigger img-post-list"></button>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-11">
                            ...
                            <div class="boxed feature modal-view-post">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="boxed boxed--border box-comment">
                                                    <div class="section-title-step">
                                                        <h4 class="title-steps">Portada</h4>
                                                        <span class="description-step-title">Selecciona o arrastra la imagen destacada para la portada de tu publicación. </span>
                                                    </div>
