faq.es = {
    "QUESTIONS": {
        ...
        "Crea Network ": ["¿Dónde se anuncian las actualizaciones y noticias relacionadas con el proyecto?"],
        "La base ": [
            "¿Qué es creary.net?",
            "¿Cómo funciona?",
            "¿ Por qué Creary es distinto a otras redes sociales convencionales ?",
            "¿Cómo debo proteger mi cuenta?",
            "¿Cuesta algo publicar, comentar o votar?",
            "¿Cómo ganar criptomonedas usando Creary?",
        ...
        "Economía": [
            "¿De dónde vienen los nuevos tokens CREA?",
            "¿Cuántos nuevos tokens genera la cadena de bloques?",
            "¿Cómo se distribuyen los nuevos tokens que se generan en cada bloque?",
            "¿En qué intercambios puedes encontrar CREA?",
            "¿Cómo se divide el grupo de recompensas entre autores y curadores?",
            "¿El grupo de recompensas pagará más o menos dependiendo de quién vote?",
            "¿Cuándo puedo reclamar mis recompensas?",
            "¿Cuál es la diferencia entre CREA, CREA Energy y CREA Dollars?",
            "¿Qué es el CREA Energy delegado?",
            "¿Qué determina el precio de CREA?",
            "¿Cómo obtengo más CREA Energy?",
            "¿Qué es Energize y De-Energize ?",
            "¿Cuánto tiempo lleva la transferencia de tokens entre usuarios dentro de la red de Crea?",
        ...
        "Navegación": [
            ...
            "¿Qué muestran los enlaces Following, Popular, Skyrockets, Now, Promoted?",
            "¿Cómo veo mis recompensas recientes?",
            "¿Qué información se muestra en mi monedero?",
        ...
        "Seguridad": [
            ...
            "¿Por qué debería tener cuidado con mi contraseña maestra?",
            "¿Por qué la contraseña maestra es una larga cadena ininteligible?",
            "¿Para qué sirven mis diferentes llaves?",
            "¿Qué hago si pierdo mi contraseña o claves privadas ?",
            "¿Están asegurados mis tokens CREA y CREA Energy en caso de que alguien haga un pirateo de tu dispositivo o cuenta?",
            "¿Qué puedo hacer si descubro que alguien ha hackeado mi cuenta?",
            "¿Cómo funciona el protocolo de recuperación de cuentas robadas?"
        ],
        "Creativechain Foundation": [
            "¿Qué es Creativechain Foundation?",
            "¿Puedo invertir en Creativechain Foundation?",
            "¿Dónde puedo ver la hoja de ruta de Crea y de Creary.net?",
            "¿Puedo usar el logotipo de Creary?"
        ],
        "Diverso": ["¿Dónde se anuncian las actualizaciones y noticias relacionadas con Creary y Crea?"],
        "Ayuda": ["¿Dónde puedo pedir ayuda si mi pregunta no fue respondida aquí?"],
        "Plagio, spam y abuso": [
            "¿Cuales son las políticas sobre el plagio o la violación de los derechos de autor?",
            "¿Dónde puedo informar sobre autores, publicaciones o comentarios que contienen plagio, spam o abuso de algún tipo?"
        ],
        "Reputación": [
        ...
        "Tecnología detrás de Creary ": [
            ...
            "¿Con qué frecuencia la blockchain de Crea produce un nuevo bloque?",
            "¿Hay alguna manera de ver los datos sin procesar que se almacenan en la cadena de bloques?",
            "¿Dónde puedo encontrar  más información sobre el funcionamiento de la blockchain de Crea ?"
        ]
    },
    "RESPONSES": {
        "Cuentas": {
        ...
        "Crea Network ": {
            ...
            "¿Dónde se anuncian las actualizaciones y noticias relacionadas con Creary y Crea?": [
                "Creary",
        ...
        "La base ": {
            "¿Cómo funciona?": [
                ...
                "Creary emite certificados de derechos de autor y licencia de distribución sobre cualquier trabajo digital que se publique. La inmutabilidad de la blockchain permite que cualquier dato que se registre en ella sea prácticamente imposible de manipular o borrar. Esto otorga un poder notarial sobre todo lo que se publica en la red de Crea sin necesidad de una autoridad central."
            ],
            "¿Cómo ganar criptomonedas usando Creary?": [
                "Puedes ganar Tokens de varias maneras:",
                "Publicando  tus creaciones: al compartir tus proyectos o creaciones digitales, puedes conseguir likes de los miembros de la comunidad. Dependiendo de los likes que recibas, obtendrás una mayor o menor proporción de la bolsa de recompensas.",
                "Participando como curador de contenidos: si descubres una publicación de calidad y la la valoras con un like antes de que se haga muy popular, puedes ganar una recompensa de curación. La cantidad de recompensa dependerá de la cantidad de CREA Energy (CGY) que tengas.",
                "Vendiendo tus contenidos: si tu modelo de capitalización de tus creaciones no pasa sólo por recibir recompensas mediante los likes, también puedes ganar CREA creando tu propio mercado de contenidos. (Stock de fotos, videos, plantillas, mockups, logos etc) ",
                "Vesting: los titulares de CGY recibirán como recompensa el 15% del cómputo total de la bolsa de recompensas. Si no mueves tu CGY serás recompensado con este porcentaje, ya que el protocolo considera que eres un usuario que participa y cee en el proyecto. ",
                "Puedes acudir a los mercados de criptomonedas: cualquier usuarios puede comprar CREA directamente en los mercados donde se comercializa. Puedes comprar CREA con las principales criptomonedas del ecosistema como Bitcoin o Ethereum o directamente con monedas fiat como el Dólar o el Euro. Consulta los principales mercados donde adquirir CREA. "
            ],
            "¿ Por qué Creary es distinto a otras redes sociales convencionales ?": [
                "En internet, la mayoría de las red sociales convencionales son centralizadas, esto quiere decir que unos pocos participan del control de la red social, de los contenidos y de la economía. En muchos casos el negocio consiste en vender los datos de los usuarios a terceros que ofrecen publicidad. Sólo unos pocos son accionistas.",
                "En Creary creemos que el poder y los beneficios se deberían de diluir entre todos los usuarios que aportan valor a la red. El 100% de los tokens emitidos por la red se distribuyen entre los usuarios de la misma. El sistema de distribución de recompensas está gobernado por la propia comunidad y cualquier usuario puede votar libremente y a tiempo real sobre cómo quiere que evolucione la red de Crea.  "
            ],
            "¿Cómo debo proteger mi cuenta?": [
                "Recuerda que en una red descentralizada nadie controla tus contraseñas o claves privadas. ",
                "A diferencia de la mayoría de los sitios web de redes sociales, No hay forma de recuperar tu cuenta si pierdes tu contraseña o clave privada. Ahora tú eres tu propio banco y tienes la responsabilidad de guardar bien tus claves. Si quieres ser libre tienes que tomar el poder sobre tus claves y esto implica un responsabilidad. ",
                "Recomendamos: ",
                "1- Hacer una copia de seguridad de la contraseña. ",
        ...
        "Portfolio": {
            "¿Qué son las etiquetas?": [
                "Las etiquetas son una forma de clasificar tu contenido, para que otros puedan encontrarlo. Trata de usar etiquetas que sean relevantes o populares para el tipo de trabajo que estás publicando. Piensa bien tus etiquetas para que otros usuarios afines puedan encontrar fácilmente tus trabajos. ",
                "Puedes navegar por las etiquetas de uso más común en Creary utilizando el enlace \"Explorar\" que encontrarás en el menú principal."
            ],
            "¿Puedo borrar algo que publiqué?": [
                "La blockchain de Crea siempre contendrá el historial completo de las ediciones de las publicaciones y  comentarios, por lo que nunca podrá eliminarse por completo. ",
            ...
            "¿Qué se puede publicar en Creary?": [
                "Creary es una plataforma de portfolios creativos, que permite subir contenidos digitales legales, imágenes, vídeos, música, textos, libros digitales o cualquier otro formato multimedia. ",
                " "
            ],
            "¿Cómo publicar un trabajo?": [
            ...
            "¿Dónde se almacenan los textos y archivos que subo desde Creary.net ?": [
                "Creary.net es un proyecto que defiende la descentralización de las redes sociales como forma de empoderar a las sociedades para que controlen sin intermediarios sus relaciones y producciones generadas en el contexto de internet. Por esta razón, los datos ( textos y metadatos) se alojan comprimidos dentro de la blockchain descentralizada y pública controlada por una la comunidad internacional que apoya este proyecto. ",
                "Los archivos más pesados como son las imágenes o videos no es muy efectivo almacenarlos directamente en la blockchain por ello conectamos la blockchain al ",
                "Sistema de archivos interplanetarios (del inglésː Inter Planetary File System - IPFS) es un protocolo y una red diseñados para crear un método peer-to-peer direccionable por contenido para almacenar y compartir hipermedia en un sistema de archivos distribuidos.",
        ...
        "Economía": {
            ...
            "¿Qué puedo hacer con mis tokens de CREA?": [
                ...
                "Transferirlo a un Exchange e intercambiar por monedas fiat como el EUR, USD o por criptomonedas como ETH, BTC o LTC.",
                "Comprar artículos o bienes digitales a través de tiendas de terceros que aceptan tokens CREA. "
            ],
            "¿Qué es Energize y De-Energize ?": [
                "Energize: si tienes tokens CREA, puedes usar la opción de Energize para convertir a CREA Energy (CGY) y de esta manera obtener más influencia de voto en las publicaciones y comentarios. Tener más CGY también aumenta la cantidad de recompensas de curación y la cantidad de nuevos tokens que puedes ganar. Cuanto más CGY tengas más influencia tendrá tu voto (Like) en la publicaciones o en la elección de un testigo de la red.",
                "De-Energize: si tienes CGY, puedes desenergizar para convertirlo en CREA líquido. Este proceso no es instantáneo. El sistema transferirá 1/8 de su CGY a CREA cada semana durante 8 semanas, comenzando 1 semana desde el momento en que se inicia. Ten en cuenta que este proceso le hará perder influencia en la red, así que piénselo bien antes de iniciar un De-Energize . "
            ],
            "¿Cómo se distribuyen los nuevos tokens que se generan en cada bloque?": [
                "-El 70% se destina al fondo de recompensas, que se divide entre autores y curadores del contenido.",
                "-El 15% de los nuevos tokens se otorgan a los titulares de CREA Energy.",
                "-El 15% restante paga a los testigos (nodos) que generan los nuevos bloques. "
            ],
            "¿Cuál es la diferencia entre CREA, CREA Energy y CREA Dollars?": [
                "CREA : es la unidad principal de la cadena de bloques de Crea. El resto de tokens obtendrán su valor de este activo principal. CREA es una moneda líquida, por lo tanto se puede comerciar con ella en los intercambios, enviarla a otros usuarios o directamente usarla como método de pago. También se puede activar en CREA Energy o intercambiar por CREA Dollars. Funciona como bitcoin o cualquier criptomoneda.",
                "CREA Energy ( CGY): es la energía creadora y un indicador del poder de cada usuario para votar a los contenidos o a los testigos de la red (DPOS). ",
            ...
            "¿Cómo obtengo más CREA Energy?": [
                "Desde la sección de CREA dentro de su billetera, haz clic en \"Energizar\" para convertirlas en CREA Energy. ",
                "Si aún no tiene CREA en tu billetera, puedes comprarlos con euro o dólar o con bitcoin (BTC) desde intercambios como Lescovex.com. Puede adquirir BTC en varios intercambios conocidos. ",
                "Consulta la lista completa https://creaproject.io/buy/  de lugares donde se comercia actualmente con CREA."
            ],
            "¿El grupo de recompensas pagará más o menos dependiendo de quién vote?": [
                "Hay una cantidad fija de monedas CREA que se agregan a la Pool de Recompensas cada día. En el corto plazo, la cantidad de monedas que se pagan puede ser mayor o menor dependiendo de la cantidad de la actividad de votación, pero con el tiempo se pagará la cantidad total de recompensas, independientemente de quién vote.",
                "Los votos en CREA son ponderados por la estaca.De esta manera, los votantes con más CREA Energy (CGY) tienen una mayor influencia sobre la asignación que los votantes con menos CGY, pero sus votos no aumentan la cantidad de recompensas en el grupo de recompensas."
            ],
            "¿Qué puedo hacer con mis tokens CBD?": [
                "Intercambiar por CREA en el mercado interno.",
                "Usarlo para comprar contenidos o bienes digitales dentro de Creary.net.",
                "Promocionar proyectos dentro de Creary.net.",
        ...
        "Navegación": {
            ...
            "¿Puedo eliminar o desactivar mi cuenta?": ["El nombre de usuario y las cuentas no pueden ser desactivadas o eliminadas. La cuenta junto con toda su actividad queda almacenada permanentemente en la blockchain de Crea. "],
            "¿Qué muestran los enlaces Following, Popular, Skyrockets, Now, Promoted?": [
                "Existen varias maneras de ordenar las publicaciones en Creary",
                "-Following: es tu feed donde puedes ver las últimas publicaciones de los artistas que estás siguiendo.",
                "-Popular: son las publicaciones con mayor repercusión y que acumulan un pago pendiente más alto. ",
                "-Skyrockets: son las publicaciones con la mayor cantidad de votos por minuto.  Son las publicaciones recientes más populares en ese momento. ",
                "-Now: son las publicaciones ordenadas partiendo de la más reciente. ",
                "-Promoted: es una lista impulsada por los pagos en CREA Dollar (CBD) para lograr mayor visibilidad.  "
            ],
            "¿Qué información se muestra en mi monedero?": [
                "Su monedero personal muestra la cantidad de tokens CREA y CREA Dollar (CBD) que dispones en tu cuenta. ",
                "Al mismo tiempo muestra la cantidad de CREA Energy (CGY) que tienes delegado y que te permite tener más poder de voto. ",
                "El monedero incorpora una función de cuenta de ahorro para CREA y CREA Dollar, que es un saldo sujeto a un período de espera de retiro de 3 días. ",
                "En el monedero también se muestra el progreso de cualquier conversión de CREA Dollar a CREA, así como el estado en el que se encuentra la Desenergización. ",
                "También muestra un valor estimado de todos los tokens en su cuenta, basado en el precio de mercado reciente de CREA.",
                "En la parte inferior del wallet puede ver el Historial donde aparecen todas las transacciones relacionadas con tu cuenta. "
            ],
            "¿Cómo transfiero mi CREA o CGY a mis ahorros?": [
            ...
            "¿Cómo envío dinero a otro usuario?": [
                ...
                "Escribe el nombre de @usuario de la cuenta a la que desea enviar el CREA. Te recomendamos hacer comprobación de la ortografía ya que si no pones el nombre correcto podría enviar tus tokens a otro usuario.",
                "A continuación Ingrese la cantidad de CREA que quiere enviar.",
                "Puede añadir una nota para acompañar la transacción (opcional).",
                "Haga clic en Enviar.",
        ...
        "Desarrolladores": {
            "¿Cómo funciona el protocolo de recuperación de cuentas robadas?": [
                "Podría suceder que alguien consiga acceder al lugar donde guardaste tu contraseña y pueda hackear tu cuenta. Si un tercero consigue la contraseña maestra podría cambiarla e impediría el acceso al propietario original de la cuenta.  ",
                "La blockchain de Crea incorpora un sistema de recuperación de cuentas robadas. Si tu contraseña ha sido cambiada sin tu consentimiento, entonces la cuenta designada como tu cuenta de recuperación puede generar una nueva clave de propietario para la cuenta. ",
                "Este proceso de recuperación debe completarse dentro de los 30 días posteriores a la modificación de la contraseña, y el usuario debe proporcionar una clave de propietario reciente que hubiese sido válida en los últimos 30 días.",
                "En este caso, Creativechain FDN posee la cuenta de recuperación predeterminada @crea para todos los usuarios que se registran desde creary.net. Esta cuenta funciona como una cuenta multifirma 2/2 por lo que necesita dos firmas válidas. ",
                "Si no tienes la contraseña maestra o la clave de propietario que era válida en los últimos 30 días, o no puedes demostrar que eres el propietario original de la cuenta, entonces tu cuenta será irrecuperable.",
                "El proceso de recuperación de la cuenta robada solo puede restaurar la propiedad de la cuenta, no es posible recuperar cualquier saldo robado. ",
                "Revisa bien tus transacciones para asegurarte bien de que ha habido un robo de tus tokens antes de solicitar una recuperación de la cuenta. Recuerda que si has olvidado la contraseña este proceso no valdrá para recuperar tu contraseña perdida. "
            ],
        ...
        "Votación y Curating": {
            ...
            "¿Cuánto cuestan las transacciones de CREA a otros usuarios?": ["No hay tarifas por ningún tipo de transferencia o conversión ( Energize o De-Energize) dentro de la red de Crea Network. "],
            "¿Dónde puedo verificar mi poder de voto?": ["Puede ver tu poder de voto actual y otros datos de tu perfil en la blockchain consultando herramientas como https://creativechain.net/@youraccount."],
            "¿Cuántas veces puedo votar sin agotar mi poder de voto?": [
            ...
            "¿Cuál es mi poder de voto?": [
                "Cuanto más contenidos votes más disminuye tu poder de voto. Cada vez que realizas un like a un contenido estás utilizando una pequeña cantidad de tu poder de voto.",
                "Cuanto más uses tu poder de voto, tus votos/likes tendrán menos influencia. Un like con el 50% del poder de voto restante valdrá la mitad que un Like con el 100% del poder de voto. La red de Crea recarga un 20% su poder de voto todos los días."
            ],
            "¿Por qué mis votaciones no tienen efecto en las recompensas de una publicación?": [
            ...
            "¿Cuáles son los motivos válidos para realizar un voto negativo al reportar un contenido?": [
                "Reportar contenido ayuda a mejorar la calidad y la convivencia de la plataforma. ",
                "Los motivos más comunes para reportar un contenido son:",
                "- Fraude o plagio ",
                "- Infracción de derechos de autor.",
                "- Contiene material ofensivo o que  fomenta el odio. ",
                "- Proyecto mal etiquetado intencionalmente o que contenga Spam.",
                "Recuerda que reportar contenido puede influir en la visibilidad y las recompensa alcanzadas por la publicación.  Depende de ti si deseas seguir estos casos más comunes para reportar un contenido. "
            ],
            "¿Puedo votar con menos del 100% de mi poder de voto?": [
        ...
        "Seguridad": {
            "¿Cómo puedo mantener segura mi cuenta de Crea?": [
                "Ni Creativechain FDN ni Creary.net guardan las contraseñas de los usuarios. Recuerda que estás en una red social descentralizada donde se crean nuevos nuevos cambios de paradigma en relación al control de los datos. Tu y solamente tu eres dueño de tu clave maestra y de las claves privadas asociadas a tu usuario. Esto conlleva ciertas libertades pero también conlleva grandes responsabilidades. ",
                "La regla principal es guardar muy bien tus claves. ",
            ...
            "¿Para qué sirven mis diferentes llaves?": [
                "Si pierdes tus claves perderás el acceso a tu cuenta para siempre. Las llaves deben almacenarse de forma privada y segura.",
                "Llave de Publicación ",
                "Los usuarios deben iniciar sesión en Creary.net siempre con la clave de publicación. La clave de publicación permite a los usuarios publicar, comentar, editar, votar, modificar y seguir o reportar a otras cuentas o contenidos. Es más probable que su contraseña o clave se vea comprometida cuanto más la use, por lo que existe una clave de publicación limitada para restringir el daño que podría causar una clave de cuenta comprometida.",
                "Llave Activa",
                "La clave activa está pensada para realizar acciones más delicadas como son la transferencia de fondos, las transacciones de Energize y De-Energize , la conversión de CBD, la acción de votar a los testigos de la red, la actualización del perfil o la colocación de una orden en el intercambio o la descarga de contenidos.",
                "Llave Memo",
                "La contraseña memo se usa para crear y leer memos. Los memos nos mensajes cifrados que se pueden enviar  en formato P2P usando la red de Crea. ",
                "Clave de Propietario",
                "La clave de propietario es la clave más poderosa ya que puede cambiar cualquiera de las otras claves de una cuenta, incluso la misma clave de propietario.",
                "Master password",
                "La contraseña maestra se utiliza para derivar todas las claves anteriores. Una función de hashing calcula las claves privadas y públicas correspondientes a partir de la contraseña maestra, el nombre de la cuenta y el tipo de clave. ",
                "La contraseña maestra permite recuperar todas las claves privadas de una cuenta de usuario. ",
                "No utilice la contraseña maestra para iniciar sesión en creary.net o en cualquier otra aplicación de la red Crea. Nunca copies la contraseña maestra en ninguna publicación y no la compartas en redes sociales usando sistemas de mensajería, correo u otras rede sociales. ",
                "Utiliza las claves de privilegios inferiores ( Lave de Publicación o Llave Activa para mantener la seguridad de tu cuenta.)  "
            ],
            "¿Qué hago si pierdo mi contraseña o claves privadas ?": [" No existe forma de recuperar su contraseña si la pierdes. Para evitar esta situación te recomendamos tomar todas las medidas de seguridad posible. Principalmente asegurate de guardar varias copias de tu contraseña en diferentes sitios seguros. "],
            "¿Por qué la contraseña maestra es una larga cadena ininteligible?": [
                "No uses una clave simple (1234567) para tu contraseña maestra, A no ser que seas Rain Man, si puedes recordar tu contraseña esto quiere decir que no es una contraseña segura. ",
                "La contraseña debe ser larga y con caracteres y números aleatorios para la máxima seguridad de tu cuenta."
            ],
            "¿Por qué debería tener cuidado con mi contraseña maestra?": ["Si alguien tiene acceso a su contraseña maestra, pueden robar su cuenta y todos los tokens que contiene."],
            "¿Cómo funciona el protocolo de recuperación de cuentas robadas?": [
                "Podría suceder que alguien consiga acceder al lugar donde guardaste tu contraseña y pueda hackear tu cuenta. Si un tercero consigue la contraseña maestra podría cambiarla e impediría el acceso al propietario original de la cuenta.  ",
                "La blockchain de Crea incorpora un sistema de recuperación de cuentas robadas. Si tu contraseña ha sido cambiada sin tu consentimiento, entonces la cuenta designada como tu cuenta de recuperación puede generar una nueva clave de propietario para la cuenta. ",
                "Este proceso de recuperación debe completarse dentro de los 30 días posteriores a la modificación de la contraseña, y el usuario debe proporcionar una clave de propietario reciente que hubiese sido válida en los últimos 30 días.",
            ...
            "¿Puedo usar el logotipo de Creary?": ["\"Creary\", el logotipo de Creary y cualquier otro nombre de producto o servicio, logotipos o lemas que puedan aparecer en el Servicio son obras titularidad de Creativechain FDN, bajo una licencia Creative Commons CC BY-ND. Esta licencia permite la redistribución, comercial y no comercial, siempre y cuando la obra no se modifique y se transmita en su totalidad, reconociendo su autoría original. La apariencia de Creary.net y el Servicio están protegidos por derechos de autor con una licencia CC BY-NC, que permite a otros entremezclar, ajustar y construir a partir de su obra con fines no comerciales, y aunque en sus nuevas creaciones deban reconocer la autoría de Creativechain FDN y no pueda ser utilizada de manera comercial, no tiene que estar necesariamente bajo una licencia con los mismos términos. Esto es aplicable a los elementos o conceptos de diseño visual de HTML / CSS, Javascript presentes en Creary.net."],
            "¿Están asegurados mis tokens CREA y CREA Energy en caso de que alguien haga un pirateo de tu dispositivo o cuenta?": [
        ...
        "Creativechain Foundation": {
            "¿Dónde puedo encontrar  más información sobre el funcionamiento de la blockchain de Crea ?": ["Toda la información relacionada con la red de Crea la podrás encontrar en la web de https://creaproject.io/ "],
            "¿Puedo invertir en Creativechain Foundation?": [
                "Creativechain Foundation es una organización privada sin ánimo de lucro y no está disponible para la inversión pública.",
                "Aunque no se considera una inversión, puede adquirir tokens de CREA que son el activo líquido que reprensenta al proyecto descentralizado impulsado por la organización. "
            ],
            "¿Dónde puedo ver la hoja de ruta de Crea y de Creary.net?": ["Por lo general en este link encontrarás los próximos pasos e implementaciones que se han planeado incorporar al sistema. https://creaproject.io/roadmap/"],
            "¿Puedo usar el logotipo de Creary?": ["\"Creary\", el logotipo de Creary y cualquier otro nombre de producto o servicio, logotipos o lemas que puedan aparecer en el Servicio son obras titularidad de Creativechain FDN, bajo una licencia Creative Commons CC BY-ND. Esta licencia permite la redistribución, comercial y no comercial, siempre y cuando la obra no se modifique y se transmita en su totalidad, reconociendo su autoría original. La apariencia de Creary.net y el Servicio están protegidos por derechos de autor con una licencia CC BY-NC, que permite a otros entremezclar, ajustar y construir a partir de su obra con fines no comerciales, y aunque en sus nuevas creaciones deban reconocer la autoría de Creativechain FDN y no pueda ser utilizada de manera comercial, no tiene que estar necesariamente bajo una licencia con los mismos términos. Esto es aplicable a los elementos o conceptos de diseño visual de HTML / CSS, Javascript presentes en Creary.net."],
            "¿Qué es Creativechain Foundation?": [
                "Es la organización sin ánimo de lucro impulsora del proyecto Crea Network y de la app Creary.net basada en este mismo protocolo blockchain de Crea Network. Su actividad principal se basa en apoyar e impulsar el desarrollo de aplicaciones descentralizadas (DAPPS) basadas en la red de Crea. La organización tiene como objetivo principal explorar los beneficios de la tecnología blockchain en el mundo de las artes y de la creación digital contemporánea. ",
                " "
            ]
        },
        "Diverso": {
        ...
        "Ayuda": {
            ...
            "¿Dónde puedo pedir ayuda si mi pregunta no fue respondida aquí?": ["Usa cualquiera de nuestras redes sociales o nuestro formulario de contacto en https://creaproject.io/contact/ (Nuestro correo puede tener un tiempo de respuesta de hasta 48h) "]
        },
        "Plagio, spam y abuso": {
            "¿Cuales son las políticas sobre el plagio o la violación de los derechos de autor?": ["Si está publicando contenido plagiado o copiado de otro autor, podría tener problemas legales por violar las leyes de derechos de autor. Las publicaciones plagiadas y el spam son vistos como abusos y los miembros de la comunidad de Creary.net los reportarán de forma negativa. Si está publicando o utilizando la obra de otra persona, primero deberá asegurarse de que tiene los derechos para usar el contenido y hacer las referencias adecuadas a las fuentes de donde obtuvo el contenidos."],
        ...
        "Testigos": {
            "¿Qué son los testigos de Crea?": [
                "La blockchain de Crea requiere un conjunto de nodos (testigos) para crear bloques y utiliza un protocolo de consenso denominado prueba de participación delegada ( DPOS). La comunidad de usuarios elige a los \"testigos\" para que actúen como los productores de bloques y de esta manera se crea un gobierno que representa a los usuarios que los han votado. ",
                "Hay 24 testigos a tiempo completo, produciendo un bloque cada ronda de 75 segundos. La posición del testigo número 25 está compartida por los testigos de respaldo que están en la cola para entrar en las lista de los 24 más votados. Este tipo de testigos están programados proporcionalmente a la cantidad de aprobación de la comunidad ponderada por el interés que tienen. Los testigos son recompensados con CREA Energy por cada bloque que crean.  ",
                "Todos los usuarios pueden votar hasta 35 testigos de la red. Si los testigos muestran indicios de estar haciendo mal su trabajo los usuarios pueden retirar su voto para sacar a ese testigo de la lista principal para que su puesto lo ocupe el siguiente testigo más votado. ",
        ...
        "Tecnología detrás de Creary ": {
            ...
            "¿Dónde puedo encontrar  más información sobre el funcionamiento de la blockchain de Crea ?": ["Toda la información relacionada con la red de Crea la podrás encontrar en la web de https://creaproject.io/ "],
            "¿Qué es Recreary? ": ["Es la función que permite a un Crearian compartir un trabajo de otro Crearian en su feed. Esta función es ideal para descubrir trabajos de otros y mostrarlos a tus seguidores. "],
            "¿Hay alguna manera de ver los datos sin procesar que se almacenan en la cadena de bloques?": ["Si, puedes visualizar todos los datos a tiempo real desde creativechain.net/@user"],
            "¿Qué es una blockchain?": [
            ...
            "¿Qué es la blockchain de Crea?": [
                ...
                "Es la matriz de información compartida que no se puede manipular y está gobernada por la propia comunidad de usuarios. "
            ]
        }
    },
    "CATEGORIES": [
